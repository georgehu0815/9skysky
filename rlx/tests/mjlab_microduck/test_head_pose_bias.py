...
def test_standup_cfg_wiring():
    from rlx.mjlab_microduck.tasks.microduck_standup_env_cfg import (
...
def test_velocity_cfg_unchanged_no_gate():
    from rlx.mjlab_microduck.tasks.microduck_velocity_env_cfg import (
...
def test_velstand_inherited_term_is_gated():
    ...
    from rlx.mjlab_microduck.tasks.microduck_velstand_env_cfg import (

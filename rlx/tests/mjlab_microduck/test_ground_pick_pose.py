import torch
from rlx.mjlab_microduck.tasks.mdp import phase_pose_blend
...
from rlx.mjlab_microduck.tasks.mdp import phase_pose_track, phase_pose_track_l1
...
def test_ground_pick_cmd_cfg_has_randomize_phase_default_true():
    from rlx.mjlab_microduck.tasks.mdp import GroundPickPhaseCommandCfg

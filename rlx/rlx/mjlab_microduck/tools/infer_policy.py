...
_MICRODUCK_ASSET_DIR = Path(__file__).resolve().parents[1] / "robot" / "microduck"
MICRODUCK_XML = str(_MICRODUCK_ASSET_DIR / "scene.xml")
...
MICRODUCK_ROLLERS_XML = str(_MICRODUCK_ASSET_DIR / "scene_rollers.xml")
MICRODUCK_BALL_XML = str(_MICRODUCK_ASSET_DIR / "scene_ball.xml")

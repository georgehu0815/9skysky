...
command grows one flag:
    ...
    uv run rlx-mjlab-train Mjlab-Kick-Flat-MicroDuck --env.scene.num-envs 4096 \
...
are consumed here and everything else is forwarded to `uv run rlx-mjlab-train` inside
the job.
"""

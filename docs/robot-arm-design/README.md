...
日期：2026-09-12 · 状态：**设计草案 / 尚未制造、训练或连接实体硬件**

## 0. 交付范围与推荐结论

本阶段交付设计，不更改现有八个技能，不修改 `microduck/` 的机器人运行代码，不声称已有机械臂模型、PPO 成果或视频。

- [中文控制中心网页原型](index.html)：离线可看，六个课堂案例可切换；不是已实现的 Studio 页面。
